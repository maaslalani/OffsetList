      ...
      >
        <Box width={[1, 1/2]} textAlign={["center", "left"]}>
          ...
          <Text mt={3} fontSize={24}>
            Companies that have committed to offsetting their carbon emissions. You can offset your carbon footprint with <Link target="_blank" rel="noopener noreferrer" href="https://projectwren.com/">Project Wren</Link>.
          </Text>
        </Box>
